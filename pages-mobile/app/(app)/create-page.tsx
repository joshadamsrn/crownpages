...
//           },
//           {
//             id: "temp_testimonial_2",
//             name: "Mike Davis",
//             position: "Owner, Local Store",
//             text: "Professional and reliable. Great experience!",
//             rating: 5,
//             avatar: "",
//             asset_type: "",
//             video_uri: "",
...
//             answer: "Yes! Contact us to schedule your free consultation.",
//           },
//         ],
//       },
//       styles: {
...
//         button: { text: "Contact Us Now", link: "tel:" },
//       },
//       styles: {
//         primary: "",
//         secondary: "",
...
//           render_type: "masonry",
//           links: [
//             { id: "temp_link_1", title: "Blue Cross Blue Shield", url: "" },
//             { id: "temp_link_2", title: "Aetna", url: "" },
//             { id: "temp_link_3", title: "UnitedHealthcare", url: "" },
//             { id: "temp_link_4", title: "Medicare", url: "" },
//             { id: "temp_link_5", title: "Medicaid", url: "" },
//           ],
//         },
//         styles: SECTION_DEFAULT_STYLES,
//       },
...
//                         Includes: Hero, About, Features, Gallery, Testimonials,
//                         FAQ, Documents, Contact, Personal Contact,
//                         Multi-Contact, CTA, Links
//                       </Text>
//                     )}
//                   </View>
//                   {selectedTemplate.id === item.id && (
...
// Default comprehensive template - Digital Brochure Style (PHN/Ovou inspired)
const COMPREHENSIVE_TEMPLATE = {
  id: "comprehensive",
  name: "All-in-One Template",
  description:
    "Complete digital brochure with all sections - PHN/Ovou style",
  sections: [
    {
      id: "temp_hero_1",
      type: "hero",
    ...
    },
    {
      ...
      data: {
        title: "About",
        content:
          "Tell your story here. What makes your business unique? What are your values and mission? Share information about your services, history, and what sets you apart from the competition.",
      },
    },
    {
      id: "temp_amenities_1",
      ...
      data: {
        ...
        amenities: [
          ...
          { id: "temp_2", name: "Parking Available" },
          { id: "temp_3", name: "24/7 Access" },
          { id: "temp_4", name: "Air Conditioning" },
          { id: "temp_5", name: "Handicap Accessible" },
          { id: "temp_6", name: "Pet Friendly" },
        ],
        itemsPerColumn: 3,
      },
    },
    {
      id: "temp_links_contact_1",
      ...
      data: {
        ...
        links: [
          ...
          },
          {
            ...
            url: "https://example.com/dimensions.pdf",
            icon: "document",
            image: "",
          },
        ],
...
export default function CreatePageScreen() {
  ...
  // CRITICAL: Check for businesses before allowing page creation
  const { isChecking: isCheckingBusinesses, hasBusinesses, checkBusinesses } = useBusinessCheck({
  ...
  const [showBusinessSelector, setShowBusinessSelector] = useState(false);
  const [isCreating, setIsCreating] = useState(false);
  const selectedTemplate = TEMPLATES[0]; // All-in-One Template (permanent)
  const [isLoading, setIsLoading] = useState(true);
  ...
  // Show loading while checking businesses or loading data
  if (isCheckingBusinesses || isLoading) {
    return <Loader />;
  }

  // If no businesses, the hook will redirect, but show loading meanwhile
          ...
          >
            ...
            >
              <View style={styles.form}>
                ...
                <View style={styles.inputGroup}>
                  <Text style={styles.label}>Template</Text>
                  <View style={[styles.templateSelector, styles.disabledSelector]}>
                    <View style={styles.templateInfo}>
                      <Ionicons
                        name={selectedTemplate.icon as any}
                        size={24}
                      ...
                      />
                      <View style={styles.templateDetails}>
                        <Text style={[styles.templateName, { color: '#333' }]}>
                          {selectedTemplate.name}
                        </Text>
                        <Text style={styles.templateDescription}>
                          {selectedTemplate.description}
